...
export function apply(ctx, config = {}) {
  ...
  const effective = {
    ...
    flashProvider: config.flashProvider ?? env("dsh_delegate_router_FLASH_PROVIDER") ?? "",
    flashModel: config.flashModel ?? env("dsh_delegate_router_FLASH_MODEL") ?? "",
    proProvider: config.proProvider ?? env("dsh_delegate_router_PRO_PROVIDER") ?? "",
    proModel: config.proModel ?? env("dsh_delegate_router_PRO_MODEL") ?? "",
